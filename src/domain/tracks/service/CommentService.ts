...
import { CommentCreateDTO, CommentCreateReturnDTO, CommentDeleteDTO, CommentDeleteReturnDTO, CommentUpdateDTO } from '../interfaces';
...
const updateComment = async (commentId: number, tableName: string, userId: number, commentDTO: CommentUpdateDTO, audioFileKey: string) => {
    try {
        ...
        await deleteS3CommentAudio(commentAudio as string); 
