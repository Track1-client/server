export default {
    ...
    UPDATE_PRODUCER_OLD_TITLE_FAIL: "프로듀서 현재 타이틀 변경 실패",
    UPDATE_PRODUCER_NEW_TITLE_FAIL: "프로듀서 변경될 타이틀 변경 실패",
    UPDATE_VOCAL_OLD_TITLE_FAIL: "보컬 현재 타이틀 변경 실패",
    UPDATE_VOCAL_NEW_TITLE_FAIL: "보컬 변경될 타이틀 변경 실패",
